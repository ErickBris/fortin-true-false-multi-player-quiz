...
public class CircleProgress extends View
{
    ...
    private int mMaxProgress = DataManager.timer;
    ...
    private void defaultParam()
    {
        ...
        this.mMaxProgress = DataManager.timer;
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        switch (type){
            ...
            case SECTOR:
                ...
                break;
            case ROUND:
                float top=this.mCircleAttribute.mRoundOval.height()-this.mCircleAttribute.mRoundOval.height()*this.mSubCurProgress/DataManager.timer;
                this.mCircleAttribute.mTextPaint.setColor(Color.BLACK);
                canvas.drawArc(this.mCircleAttribute.mRoundOval, 0.0F, 360.0F, this.mCircleAttribute.mBRoundPaintsFill, this.mCircleAttribute.mBottomPaint);
    ...
    class CircleAttribute
    {
        ...
        public int mBottomPaintColor= getResources().getColor(R.color.yellowcolor);
        public int mMainPaintColor=Color.RED;
        ...
        public int   mTextPaintColor=getResources().getColor(R.color.Black);
